const sources =    [{
  ...
  //   console.log(key);
  //    sourceObj[key].map((source, index)=>{
  //     console.log(source);
  //   });
  //   console.log('==========================');
  //   console.log();
  ...
  //   console.log(source);
  //   if (sourceObj[sources[source].language] !== undefined){
  //     sourceObj[sources[source].language].push(sources[source].name);
  //   } else {
  //     sourceObj[sources[source].language] = [];
  //     sourceObj[sources[source].language].push(sources[source].name);
  //   }
  // };
